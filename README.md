...
A continuación se muestra un screenshot del despliegue de nuestro sistem de recomendación en la plataforma de Streamlit, en donde se observa las recomendaciones para el usuario de restarantes de Tacos.
